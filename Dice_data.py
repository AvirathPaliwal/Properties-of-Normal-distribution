...
data_within_1_std = [result for result in dice_result if result > first_std_start and result < first_std_end]
data_within_2_std = [result for result in dice_result if result > second_std_start and result < second_std_end]
data_within_3_std = [result for result in dice_result if result > third_std_start and result < third_std_end]

print( " {} % of data lies within 1 standard deviation ".format( len(data_within_1_std)*100.0/len(dice_result) ) )
print( " {} % of data lies within 2 standard deviation".format( len(data_within_2_std)*100.0/len(dice_result) )  )
print( " {} % of data lies within 3 standard deviation".format( len(data_within_3_std)*100.0/len(dice_result) )  )